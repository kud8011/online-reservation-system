...
<body>
	...
	<div class="vertical-nav bg-white" id="sidebar">
		...
		<ul class="nav flex-column bg-dark mb-0">
			...
			<li class="nav-item dropdown"><a href="#" class="nav-link">
					<i class="fa fa-train mr-3  fa-fw"></i> Train
			</a></li>
	...
	<div class="page-content p-5" id="content">
		...
		<!-- Demo content -->
		<h2 class="display-4 text-dark">Online Train Booking</h2>
		...
		<button type="button" id="button" class="btn btn-dark float-right ">
			<a href="AddTrain.jsp">New Train</a>
		</button>
				...
				<tbody>
					<c:forEach var="row" items="${result.rows}">
						<tr>
							...
							<td><a class="v1"
								href="UpdateTrain.jsp?TrainNumber=<c:out value="${row.TrainNumber}"/>&choice=update"><button type="button" class="btn btn-primary"> <i class="fa fa-pencil-square-o"></i>
								Update</button></a>
								<a class="v"
								href="TrainServlet?TrainNumber=<c:out value="${row.TrainNumber}"/>&choice=delete"><button type="button" class="btn btn-danger"><i class="fa fa-trash mr-2"></i>Delete</button></a>
							</td>
