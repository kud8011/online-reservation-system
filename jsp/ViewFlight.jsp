...
<body>
	...
	<div class="vertical-nav bg-white" id="sidebar">
		...
		<ul class="nav flex-column bg-dark mb-0">
			<li class="nav-item "><a href="admin.jsp" class="nav-link ">
					<i class="fa fa-home mr-3  fa-fw"></i> Dashboard
			</a></li>

			<li class="nav-item dropdown"><a href="ViewBus.jsp"
				class="nav-link"> <i class="fa fa-bus mr-3  fa-fw"></i> Bus
			</a></li>
			...
			<li class="nav-item dropdown"><a href="#" class="nav-link">
					<i class="fa fa-plane mr-3  fa-fw"></i> Airline
			</a></li>
			<li class="nav-item "><a href="Customers.jsp" class="nav-link ">
					<i class="fa fa-users mr-3  fa-fw"></i> Customers
			</a></li>
				...
				<tbody>
					<c:forEach var="row" items="${result.rows}">
						<tr>
							...
							<td><c:out value="${row.FlightNumber}" /></td>
							<td><c:out value="${row.FlightType}" /></td>
							...
							<td><a class="v1"
								href="UpdateFlight.jsp?FlightNumber=<c:out value="${row.FlightNumber}"/>&choice=update"><button type="button" class="btn btn-primary"> <i class="fa fa-pencil-square-o"></i>
								Update</button></a>
								<a class="v"
								href="FlightServlet?FlightNumber=<c:out value="${row.FlightNumber}"/>&choice=delete"><button type="button" class="btn btn-danger"><i class="fa fa-trash mr-2"></i>Delete</button></a>
							</td>
						</tr>
					</c:forEach>
				</tbody>
	...
	<script type="text/javascript">
		...
		if (status == "added") {
			swal("Excellent", "You Have Successfuly Added.", "success");
