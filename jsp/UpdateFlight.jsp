...
<body>
	...
	<div class="page-content p-5" id="content">
		...
		<!-- Demo content -->
		<h2 class="display-4 text-dark">Online Flight Booking</h2>
		...
		<div class="row text-dark">
			<div class="col-lg-7">
				...
				<div class="form-style-2">
					<div class="cantainer">
						<div class="form-style-2-heading">Update Flight information</div>

						<form action="FlightServlet" method="post">
							<label for="field1"><span>Flight Name:</span> 
								<input type="text" class="input-field" name="flightName" value="<%=flight.getFlightName()%>" readonly="readonly" /> 
							</label>
							
							
							 <label for="field2"><span>Flight Number:</span> 
								 <input type="text" class="input-field" name="flightNumber" value="<%=flight.getFlightNumber()%>" readonly="readonly" /> 
							 </label> 
							 
							 <label for="field2"><span>Flight Type:</span> 
							 	<input type="text" class="input-field" name="flightType" value="<%=flight.getFlightType()%>" readonly="readonly" /> 
							 </label> 
							 
							 <label for="field3"><span>From Station:</span> 
								 <input type="text" class="input-field" name="fromStation" value="<%=flight.getFromStation()%>" /> 
							 </label> 
							 
							 <label for="field4"><span>To Station:</span> 
							 	<input type="text" class="input-field" name="toStation" value="<%=flight.getToStation()%>" /> 
							 </label> 
							 
							 <label for="field5"><span>Departure Date:</span> 
							 	<input type="date" class="input-field" name="departure" value="<%=flight.getDeparture()%>" /> 
							 </label> 
							 
							 <label for="field5"><span>Departure Time:</span> 
								 <input type="time" class="input-field" name="departureTime" value="<%=flight.getDepartureTime()%>" /> 
							 </label> 
							 
							 <label for="field5"><span>Arrival Time:</span> 	
							 	<input type="time" class="input-field" name="ArrivalTime" value="<%=flight.getArrivalTime()%>" /> 
							 </label> 
							 	
							 <label for="field5"><span>Price(In INR)</span> 
							 	<input type="number" class="input-field" name="priceINR" value="<%=flight.getPrice()%>" /> 
							 </label>
							 
							  <input type="hidden" id="status" value="<%=request.getAttribute("status")%>">

							<label><span></span> 
							<input type="submit" value="update" name="choice" /> </label>
						</form>
					</div>
				</div>
			</div>
